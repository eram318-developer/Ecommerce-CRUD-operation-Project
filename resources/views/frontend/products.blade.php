 ...
 <div class="container-fluid">
  <div class="row prod_pg1">
	...
	<div class="prod_2i1 clearfix">
	  <div class="grid clearfix">
			  <figure class="effect-jazz mb-0">
				<a href="detail.html"><img src="product/{{ $product->image }}" class="w-100" alt="abc" style="width:100px;"></a>
			  </figure>
		  </div>
		</div>
		...
		<div class="prod_2i3 clearfix position-absolute w-100">
			...
			<h6 class="bg_yell d-inline-block pt-1 pb-1 font_13 text-white ps-3 pe-3 pull-right">Discount {{ $product->discount_price }} BDT</h6>
		</div>
		<div class="prod_2in clearfix position-absolute bg-light w-100 p-3 text-center">
	       ...
	       <div class="prod_2i2 pt-4 pb-4 ps-3 pe-3 bg-white clearfix">
		     <span class="col_yell">
				...
				<h6 class="font_13">{{ $product->price }} BDT</h6>
		<hr>
